...
#[AsCommand(
    'setono:sylius-google-ads:prune-conversions',
    'Prunes/removes conversions from the conversions table that are too old to be qualified for uploading to Google Ads',
)]
