...
interface ConversionActionInterface extends ResourceInterface, CodeAwareInterface, ToggleableInterface, ChannelsAwareInterface
{
    ...
    /**
     * This is the same name as the conversion action inside the Google Ads interface
     */
